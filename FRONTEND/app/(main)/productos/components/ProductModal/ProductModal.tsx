...
import { ProductModalStep1 } from "./ProductModalStep1";
import { ProductModalStep2 } from "./ProductModalStep2";
import { ProductModalStep3 } from "./ProductModalStep3";
import { ProductModalFooter } from "./ProductModalFooter";
import {
  validateStep1,
  validateStep2,
  validateStep3,
} from "./ProductModalValidations";
...
const steps = [
  { id: 1 as StepNumber, title: "Información Básica", icon: Package },
  { id: 2 as StepNumber, title: "Precios y Costos", icon: DollarSign },
  { id: 3 as StepNumber, title: "Inventario y Preparación", icon: ShoppingBag },
];
...
export function ProductModal({
  ...
  const { isValid: isStep1Valid } = validateStep1(producto);
  const { isValid: isStep2Valid } = validateStep2(producto);
  const { isValid: isStep3Valid } = validateStep3(producto);
            ...
            <div className="flex items-center gap-4">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  {editingProduct
                    ? `Actualiza la información de ${editingProduct.nombre}`
                    : "Ingresa los datos requeridos para registrar un nuevo producto en el catálogo"}
                </p>
              </div>
            </div>
