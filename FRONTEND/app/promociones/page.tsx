...
const promocionesData: Promocion[] = [
  {
    id: 1,
    titulo: "Miercoles de cervezas al 2x1",
    descripcion:
      "¡2x1 en nuestras cervezas, aplica para todos los tipos de cerveza.",
    descuento: "",
    tipo: "2x1",
    valor: 50,
    imagen: "/cerveza_promo.jpg",
    activa: true,
  ...
  {
    id: 2,
    titulo: "Combo de hamburguesas",
    descripcion: "2 hamburguesas clasicas con papas.",
    descuento: "",
    tipo: "combo",
    valor: 25,
    imagen: "/hamburguesa_promo.jpg",
    activa: true,
  ...
  {
    id: 4,
    titulo: "Alitas con 30% descueto",
    descripcion: "En la compra de 1 bebida especial, se te aplicara un descuento del 30% a cualquier platillo de alitas que cosumas.",
    descuento: "",
    tipo: "porcentaje",
    valor: 30,
    imagen: "/alitas_promo.jpg",
    activa: true,
  ...
  {
    id: 6,
    titulo: "Noche de margaritas",
    descripcion: "¡2X1 en nuestras margaritas, a partir de las 11:00 p.m.!.",
    descuento: "",
    tipo: "porcentaje",
    valor: 15,
    imagen: "/margarita_promo.jpg",
    activa: false,
  ...
  {
    id: 8,
    titulo: "Noche tropical de piñas coladas",
    descripcion: "Este sábado vive la Noche Tropical de Piña Coladas en KantarEs, a partir de las 11:30 p.m.",
    descuento: "",
    tipo: "porcentaje",
    valor: 25,
    imagen: "/pinacolada_promo.jpeg",
    activa: true,
    fecha_inicio: new Date("2024-01-01"),
    fecha_fin: new Date("2024-12-31"),
    usos: 45,
